...
const SignUp = () => {
  const [isSignIn, setIsSignIn] = useState(false); // State to track sign in mode
  ...
  return (
    <Box maxW="400px" m="auto">
      ...
      <Formik
        ...
        validate={validate}
        onSubmit={isSignIn ? handleSignIn : handleSignUp} // Use appropriate handler based on mode
      >
